...
<section id="instant-messaging"></section>
...
<img src="../img/apps/signal.png" width="20" height="20" alt="Signal" /> [Signal](https://signal.org/) <sup>[Play Store](https://play.google.com/store/apps/details?id=org.thoughtcrime.securesms) | [GitHub](https://github.com/signalapp)</sup> 🇺🇸 <sup>US</sup> 👑 ⭐ ❤️
...
<img src="../img/apps/element.png" width="20" height="20" alt="Element" /> [Element](https://element.io/) ([Matrix](https://matrix.org/) Client) <sup>[F-Droid](https://f-droid.org/en/packages/im.vector.app/) | [GitHub](https://github.com/element-hq)</sup> 🇬🇧 <sup>GB</sup> ⭐
...
<img src="../img/apps/session.png" width="20" height="20" alt="Session" /> [Session](https://getsession.org/) <sup>[Play Store](https://play.google.com/store/apps/details?id=network.loki.messenger) | [GitHub](https://github.com/session-foundation)</sup> 🇦🇺 <sup>AU</sup>
...
<img src="../img/apps/simplex.png" width="20" height="20" alt="SimpleX" /> [SimpleX](https://simplex.chat/) <sup>[F-Droid](https://f-droid.org/en/packages/chat.simplex.app/) | [GitHub](https://github.com/simplex-chat)</sup> 🇬🇧 <sup>GB</sup>
