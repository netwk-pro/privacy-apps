...
<img src="../img/apps/veracrypt.png" width="20" height="20" alt="VeraCrypt" /> [VeraCrypt](https://veracrypt.io) <sup>[GitHub](https://github.com/veracrypt/VeraCrypt)</sup> 🇫🇷 <sup>FR</sup> 👑
...
<img src="../img/apps/gpg.svg" width="20" height="20" alt="GnuPG" /> [GNU Privacy Guard](https://gnupg.org) <sup>[Repo](https://git.gnupg.org/)</sup> 🇩🇪 <sup>DE</sup> 👑 ⭐
